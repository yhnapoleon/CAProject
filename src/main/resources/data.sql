...
-- 插入测试用户 (1个顾客, 1个管理员)
INSERT INTO users (id, username, password, email, role, personal_details) VALUES
                                                                              (1, 'test_customer', 'password', 'customer@test.com', 'CUSTOMER', '{"address": "Test Address 1"}'),
                                                                              (2, 'test_admin', 'adminpass', 'admin@test.com', 'ADMIN', '{"department": "Test Dept"}');

-- 插入测试商品
INSERT INTO products (id, name, category, description, price, stock_quantity, is_visible) VALUES
                                                                                              (101, '测试笔记本', '电子产品', '用于测试的笔记本电脑', 100.00, 10, TRUE),
                                                                                              (102, '测试书籍', '书籍', '用于测试的书籍', 20.00, 50, TRUE),
                                                                                              (103, '测试T恤', '时尚服饰', '用于测试的T恤', 5.00, 100, TRUE);
...
INSERT INTO orders (id, order_date, total_amount, status, user_id) VALUES
